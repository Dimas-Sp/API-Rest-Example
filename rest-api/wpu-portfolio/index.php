...
function get_CURL($url)
{
  ...
  $result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCEMGgbJCfbz1nfu_mbNgekg&key=AIzaSyDhw4SMtkgX43uiKKMqg1WRakEjlK6ESFM');
  ...
  //lates video
  $urlLatesVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyDhw4SMtkgX43uiKKMqg1WRakEjlK6ESFM&channelId=UCEMGgbJCfbz1nfu_mbNgekg&MaxResults=1&order=date&part=snippet';
          ...
          <div class="col-md-5">
            <div class="row">
              ...
              <div class="col-md-8">
                ...
                <div class="g-ytsubscribe" data-channelid="UCEMGgbJCfbz1nfu_mbNgekg" data-layout="default" data-count="default"></div>
              </div>
            </div>
